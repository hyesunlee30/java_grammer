...
public class Sprinkle {
    ...
    public static int solution(int n, int[] nums) {
        int answer = 0;
        // [index][index - nums[index]] & [index][index + nums[index]]
        // 각 위치에서 물을 뿌리는 범위 저장
    ...
    public static void main(String[] args) {
        System.out.println(Sprinkle.solution(8, new int[]{1, 1, 1, 2, 1, 1, 2, 1, 1}));
//        System.out.println(Sprinkle.solution(4, new int[]{1, 2, 2, 0, 0}));
//        System.out.println(Sprinkle.solution(5, new int[]{2, 0, 0, 0, 0, 2}));
//        System.out.println(Sprinkle.solution(11, new int[]{1, 2, 3, 1, 2, 1, 1, 2, 1, 1, 1, 1}));
    }
}
